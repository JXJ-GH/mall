...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <c:if test="${requestScope.info==null}">
            ...
            <form method="post" class="form-x" action="/store/commodity/handle.do?_method=insert">
...
<%--                </div>--%>
        ...
        <c:if test="${requestScope.info!=null}">
            <form method="post" class="form-x" action="/store/commodity/handle.do?_method=updateSubmit&sjsort=${requestScope.info.sjsort}">
                <div class="form-group">
                    <div class="label">
                        <label>商品ID：</label>
                    </div>
