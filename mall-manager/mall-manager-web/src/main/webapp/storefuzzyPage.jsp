                                ...
                                <td>
                                    <div class="button-group">
                                        <a class="button border-main"
                                           href="/store/commodity/handle.do?_method=updateChange&id=${fuzzyInfo.commodityId}">修改</a>
                                        <a class="button border-red"
                                           href="/store/commodity/handle.do?_method=delete&id=${fuzzyInfo.commodityId}"
