...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="/commodity/handle.do?_method=putGoods&stock=${requestScope.goodsInfo.commodityStock}&degree=${requestScope.goodsInfo.commodityDegree}&id=${requestScope.goodsInfo.commodityId}">
            <div class="form-group">
                <div class="label">
                    <label>上架顺序：</label>
                </div>
                <div class="field">
                    <input type="text" class="input w50" value="${requestScope.goodsInfo.commoditySort}"
                           name="sort"/>
                    <div class="tips"></div>
                </div>
            </div>
