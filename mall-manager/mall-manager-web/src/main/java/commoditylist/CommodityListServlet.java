...
import service.commodityServiceImpl.CommodityServiceImpl;
...
@WebServlet("/commodity/handle.do")
public class CommodityListServlet extends HttpServlet {
    ...
    public void delete(HttpServletRequest req, HttpServletResponse resp) {
        ...
        cSI.pageDelete(id);
        try {
            req.getRequestDispatcher("/commodity/handle.do?_method=pagingSelect&currentPage=" + cPage).forward(req, resp);
        } catch (ServletException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void insert(HttpServletRequest req, HttpServletResponse resp) {
        ...
        String commodityDistributor = req.getParameter("distributor");
        ...
        cSI.pageInsert(cIfo);
        try {
            req.getRequestDispatcher("/commodity/handle.do?_method=pagingSelect").forward(req, resp);
        } catch (ServletException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void fuzzySearch(HttpServletRequest req, HttpServletResponse resp){
        ...
        CommodityServiceImpl cSI = new CommodityServiceImpl();
        List<CommodityIfo> lCInfo = cSI.fuzzySearch(str);
        System.out.println(lCInfo);
        req.setAttribute("fuzzySInfo",lCInfo);
        try {
            req.getRequestDispatcher("/fuzzyPage.jsp").forward(req,resp);
        } catch (ServletException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void updateChange(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            req.getRequestDispatcher("/commodityInformation.jsp").forward(req, resp);
        } catch (ServletException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void putGoodsConfirm(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            req.getRequestDispatcher("/putGoods.jsp").forward(req, resp);
        } catch (ServletException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void putGoods(HttpServletRequest req, HttpServletResponse resp) {
        ...
        String commodityDistributor = req.getParameter("distributor");
        int commodityStock = Integer.parseInt(req.getParameter("stock"));
        int commoditySort = Integer.parseInt(req.getParameter("sort"));
        CommodityIfo cIfo = new CommodityIfo();
        cIfo.setCommodityId(commodityId);
        cIfo.setCommodityName(commodityName);
        cIfo.setCommodityPrice(commodityPrice);
        ...
        cIfo.setCommodityDegree(commodityDegree);
        cIfo.setCommodityDistributor(commodityDistributor);
        cIfo.setCommoditySort(commoditySort);
        cIfo.setCommodityStock(commodityStock);
        CommodityServiceImpl cSI = new CommodityServiceImpl();
        cSI.pageUpdate(cIfo);
        try {
            req.getRequestDispatcher("/commodity/handle.do?_method=productDisply").forward(req, resp);
        } catch (ServletException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
